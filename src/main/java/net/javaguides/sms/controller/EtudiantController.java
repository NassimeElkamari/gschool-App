...
import net.javaguides.sms.entity.Etudiant;
import net.javaguides.sms.entity.Filiere;
import net.javaguides.sms.service.CloudinaryService;
import net.javaguides.sms.service.EtudiantService;
import net.javaguides.sms.service.ExportEtudiantService;
...
public class EtudiantController {
    ...
    public String searchEtudiants(
        ...
        if ("XMLHttpRequest".equals(requestedWith)) {
            return "fragments/etudiant/etudiants :: #etudiantsBody"; // Return only the table body
        }

        return "etudiants"; // Return the full page for non-AJAX requests
    }
